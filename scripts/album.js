...
var albumCover = document.getElementsByClassName('column half')[0].children[0];
    ...
    if (currentAlbum === albumPicasso.name) {
        ...
        setCurrentAlbum(tameImpala);
    } else if (currentAlbum === tameImpala.name) {
...
var createSongRow = function(songNumber, songName, songLength) {
    ...
    var clickHandler = function() {
        ...
        //Revert to song number for currently playing song, user started playing new song.
...
var setCurrentAlbum = function(album) {
    ...
    //Replace the content of the text nodes
...
//Updates the text of the <h2> tags that contain the song name and artist name. 
...
//Variables in the global scope to hold current song/album info
